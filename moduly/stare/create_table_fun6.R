...
CreateTable <-function(tabela_wejsciowa,nazwa_tabeli="", pomocnicza){
 ...
 #
  ...
  if(colnames(tabela_wejsciowa)[1]=="MaterialGroup"){
...
#### 4 poziomy grupowania ------------------------------------------------------------------------------------------
  ...
  Podkreslanie                                  <- c(which(unlist(tabela_wejsciowa[,4]) %in% PoziomGrupowania1))
...
tab  <- CreateTable(MAIN_WhDir_MTH,nazwa_tabeli = "MAIN_WhDir_MTH")
asd  <- tab[[1]]
