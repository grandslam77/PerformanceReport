...
wykresKolumnowyQuant2<-ggplot(bazaQuantKol, aes(x = Abr, y = zmiana,fill="#A03FFF" )) +
  ...
  theme(legend.position = "none") +
  geom_text(aes(y = 0, label = str_wrap(paste(zmiana,"%",sep=""), width = 10)),vjust = ifelse(bazaQuantKol$zmiana>0,1.5,-0.5), size=2.7,colour=ifelse(bazaQuantKol$zmiana>0,"black","black")) + #,fontface="bold"
  theme(plot.title = element_text(hjust = 0.5, vjust = -0.5,size = 9.5,face="bold"), plot.margin = unit(c(0.3, 0.5, 0, 0), "cm")) +
  theme(axis.line.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
  theme(axis.line.x = element_blank(), axis.text.x = element_text(size = 6), axis.ticks.x = element_blank()) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) +
  #theme(panel.grid = element_blank())+
  theme(panel.background = element_blank())
...
wykresKolumnowyTurn2<-ggplot(bazaTurnKol, aes(x = Abr, y = zmiana,fill="#A03FFF" )) +
  #geom_col(fill = "transparent", color = "#800080") +
  geom_col() +
  scale_fill_manual(values = "#A03FFF") +
  labs(title = "TURNOVER CHANGES (%Y/Y)", x = "", y = "") +
  theme(legend.position = "none") +
  geom_text(aes(y = 0, label = str_wrap(paste(zmiana,"%",sep=""), width = 10)),vjust = ifelse(bazaTurnKol$zmiana>0,1.5,-0.5), size=2.7,colour=ifelse(bazaTurnKol$zmiana>0,"black","black")) + #,fontface="bold"
  theme(plot.title = element_text(hjust = 0.5, vjust = -0.5,size = 6.5,face="bold"), plot.margin = unit(c(0, 0.5, 0, 0), "cm")) +
  theme(axis.line.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
  theme(axis.line.x = element_blank(), axis.text.x = element_text(size = 6), axis.ticks.x = element_blank()) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) +
...
wykresKolumnowyMargin2<-ggplot(bazaMarginKol, aes(x = Abr, y = zmiana,fill="#A03FFF" )) +
  #geom_col(fill = "transparent", color = "#800080") +
  geom_col() +
  scale_fill_manual(values = "#A03FFF") +
  labs(title = "MARGIN CHANGES (%Y/Y)", x = "", y = "") +
  theme(legend.position = "none") +
  geom_text(aes(y = 0, label = str_wrap(paste(zmiana,"%",sep=""), width = 10)),vjust = ifelse(bazaMarginKol$zmiana>0,1.5,-0.5), size=2.7,colour=ifelse(bazaMarginKol$zmiana>0,"black","black")) + #,fontface="bold"
  theme(plot.title = element_text(hjust = 0.5, vjust = -0.5,size = 6.5,face="bold"), plot.margin = unit(c(0, 0.5, 0, 0), "cm")) +
  theme(axis.line.y = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
  theme(axis.line.x = element_blank(), axis.text.x = element_text(size = 6), axis.ticks.x = element_blank()) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) +
