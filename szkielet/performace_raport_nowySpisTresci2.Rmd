...
<!-- ```{r seltup, include=FALSE} -->
<!-- # Zaimportuj czcionki -->
<!-- library(extrafont) -->
<!-- font_import() -->

<!-- # Wybierz niestandardową czcionkę -->
<!-- loadfonts(device = "win") -->
<!-- windowsFonts(mojafont = "Brenntag Sans") -->
...
\scriptsize Total sales (3rd party + intercompany)
...
## EUROPEAN INDUSTRIES BY MATERIAL TYPES  (`r MiesiacAnalizyTekst`)
...
## EUROPEAN INDUSTRIES BY MATERIAL TYPES (YTD)
...
## TOP 20 MATERIAL GROUPS BY MARGIN (`r MiesiacAnalizyTekst`)
...
## BOTTOM 20 MATERIAL GROUPS BY GP (`r MiesiacAnalizyTekst`)
...
## BOTTOM 20 MATERIAL GROUPS BY GP (YTD)
